...
export DISPLAY=:1
x11vnc -display :1 -nopw -forever -shared --rfbport -loop 5901&
x11vnc -display :2 -nopw -forever -shared --rfbport -loop 5902&
x11vnc -display :3 -nopw -forever -shared --rfbport -loop 5903&
